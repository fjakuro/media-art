    ...
    <div className="app">
      <section className="instructions">
        ...
        <ol>
          ...
          <li>「全画面（立体視）表示」ボタンを押し、表示された画面を全画面にして横画面表示にしてください。<br/><span className="sub-instruction">（VRゴーグルがない場合などは立体視表示せずそのままお楽しみください。）</span></li>
          <li>スマートフォン用VRゴーグルにセットして覗き込みましょう。</li>
